...
```javascript
import contains from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-assert-contains@v0.0.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-assert-contains@v0.0.1-deno/mod.js';
```
